function getAllTecnicos(codTecnico) {
    $.ajax({
        url: "https://unfurbished-elissa-dcollet.ngrok-free.dev/Api-Tecnicos---cloudinary/tecnicos",
        type: "GET",
...
function enviar(codTecnico, nombreTecnico, importe, delegacion, fecha, alimento, ticket) {
    ...
    $.ajax({
        url: "https://unfurbished-elissa-dcollet.ngrok-free.dev/Api-Tecnicos---cloudinary/gastos",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
